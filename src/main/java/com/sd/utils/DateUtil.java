...
public class DateUtil{
    ...
    /**
     * yy-MM-dd 格式的日期转换为 yyMMdd
     * @param date
     * @return
     */
    public static String getDateString(String date) {
        SimpleDateFormat dft= new SimpleDateFormat("yyyy-MM-dd");
        SimpleDateFormat dft1= new SimpleDateFormat("yyyyMMdd");
        Date date1;
		try {
			date1 = dft.parse(date);
	        return dft1.format(date1);
    ...
    public static Date getCurrentDate() {
        ...
        Date date1 = null;
	    try {
			date1 = dft.parse(dft.format(new Date()));
	        return date1;
		} catch (ParseException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
     ...
     * 获得指定日期的前后N天
     */
    public static String countDate(String datetmp,int day){
    	DateFormat dft=new SimpleDateFormat("yyyy-MM-dd");
        Date temp;
		try {
			temp = dft.parse(datetmp);
    	Calendar cld = Calendar.getInstance();
        cld.setTime(temp);        
        cld.add(Calendar.DATE, day);//加减天数
         temp=cld.getTime();
    ...
    public static String sTountDate(String datetmp,int day){
    ...
    public static String getToday() {
        return DateUtil.parseDateToStr(new Date(), DateUtil.DATE_FORMAT_YYYYMMDD);
    }
     ...
     * @return
     */
    public static String getTodayFormate(String formate) {
        return DateUtil.parseDateToStr(new Date(), formate);
    }
    ...
    public static String getStartTime(String date) {
    	if(StringUtils.hasText(date)) {
    		...
    		return getTodayFormate(DATE_FORMAT_YYYY_MM_DD) + " 00:00:00";
    	}
    }
    ...
    public static String getEndTime(String date) {
    	if(StringUtils.hasText(date)) {
    		...
    		return getTodayFormate(DATE_FORMAT_YYYY_MM_DD) + " 23:59:59";
    	}
    }
